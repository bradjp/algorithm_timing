...
describe Find_duplicates do
  ...
  describe '#find_duplicates' do
    ...
    it "returns 'No duplicates' when input contains no repeated words" do
      expect(subject.find_duplicates(%w[hello world])).to eq('No duplicates')
    end
    it 'returns repeated word' do
      expect(subject.find_duplicates(%w[hello world hello])).to eq('hello')
    end
    it 'returns multiple repeated words' do
      expect(subject.find_duplicates(%w[hello world hello echo echo])).to eq('hello, echo')
    end
  end
end
